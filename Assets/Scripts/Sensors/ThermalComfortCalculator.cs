...
namespace GoNatureAR.Sensors
{
    public class ThermalComfortCalculator
    {
        public double PMV;
        public int PPD;
        // Air temperature in °C (input this value)
        // Relative humidity in % (input this value)
        public ThermalComfortCalculator(double airTemperature, double relativeHumidity)
        {
            // Calculate PMV/PPD
            PMV = CalculatePMV(airTemperature, relativeHumidity);
        ...
        /// <summary>
        /// Returns Predicted Mean Vote (PMV) only by ggiven <paramref name="rh"/> and <paramref name="tdb"/>.
        /// Parameters
        /// -----------
        ...
        public double CalculatePMV(double airTemperature, double relativeHumidity)
        {
        ...
        /// <returns></returns>
        public int CalculatePPD(double pmv)
        {
