...
namespace GoNatureAR
{
    public class DataManager : MonoBehaviour
    {
        ...
        public static Action<SensorType> OnDataUpdated;
        ...
        {   
            ...
            OnDataUpdated?.Invoke(SensorType.thermal);
        }
        ...
        {   
            ...
            OnDataUpdated?.Invoke(SensorType.air);
        }
        ...
        {   
            ...
            OnDataUpdated?.Invoke(SensorType.noise);
        }
        ...
        public double PpbToMicrogramsPerCubicMeter(double ppb, double molecularWeight)
        {
            const double standardTemperatureInKelvin = 298.15; // 25 degrees Celsius in Kelvin
            const double standardPressureInAtm = 1; // 1 atmosphere
            const double universalGasConstant = 0.0821; // in L*atm/(K*mol)
